# VentureLeap\OrderService\ConfigurationEntryApi
...
> \VentureLeap\OrderService\Model\InlineResponse200 getConfigurationEntryCollection($key, $sub_key, $value, $application_id, $page)
